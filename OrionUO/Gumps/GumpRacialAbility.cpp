...
{
    g_ToolTip.Set(g_ClilocManager.GetCliloc(g_Language)->GetW(1112198 + (Serial - 0x5DD0), true), 200);
}
...
void CGumpRacialAbility::OnAbilityUse(u16 index)
{
    switch (index)
    {
        case 0x5DDA:
